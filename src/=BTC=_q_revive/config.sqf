...
btc_qr_help_radius = 100; //Check for helpers nearby
...
btc_qr_multiple_spawn = false; //If true a dialog will appear after respawn and you can select where to spawn (Only players)
